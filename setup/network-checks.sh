# Install the 'host'(from bind-utils) and and 'nc' (from nmap-ncat) tools. 
# This script is run before the rest of the system setup so we may not yet 
# have things installed.
hide_output yum --assumeyes --quiet install bind-utils nmap-ncat || exit 1
